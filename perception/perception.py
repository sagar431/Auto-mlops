...
logger = get_logger("perception.perception")
...
class Perception:
    ...
    def _load_prompt(self, path: str) -> str:
        ...
        try:
            ...
            logger.warning("Could not load perception prompt", path=path, error=str(e))
...
"""
    ...
    async def run(self, perception_input: dict[str, Any], session: Any = None) -> dict[str, Any]:
        """
        ...
        try:
            ...
            logger.error("Perception error", error=str(e))
...
def build_perception_input(
    query: str, memory: list, ctx: Any, snapshot_type: str = "initial"
) -> dict[str, Any]:
    """
