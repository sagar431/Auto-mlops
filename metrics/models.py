...
class AccuracyMetrics(BaseModel):
    ...
    best_accuracy: float | None = Field(None, description="Best accuracy achieved")
    avg_accuracy: float | None = Field(None, description="Average accuracy across runs")
    accuracy_improvement_rate: float | None = Field(
        None, description="Rate of accuracy improvement"
    )
