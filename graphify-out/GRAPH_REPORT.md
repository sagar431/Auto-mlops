...
## Corpus Check
- 200 files · ~339,996 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 13560 nodes · 26724 edges · 1742 communities (326 shown, 1416 thin omitted)
- Extraction: 50% EXTRACTED · 50% INFERRED · 0% AMBIGUOUS · INFERRED: 13366 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8aabd3b2`
...
4. `AgentLoop` - 528 edges
5. `AuthenticationError` - 517 edges
6. `SessionRepository` - 437 edges
7. `ModelMetrics` - 419 edges
8. `ValidationSeverity` - 402 edges
9. `AsyncSessionRepository` - 398 edges
10. `DataValidator` - 380 edges
...
## Communities (1742 total, 1416 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (389): AddDataToDVCInput, AnalyzeTrainingResultsInput, BuildMLDockerImageInput, BuildSmokeCheckCapstoneContainerImageInput, CheckAccuracyThresholdInput, CheckWorkflowRunInput, ConfigureDVCRemoteInput, ConfigureValidateCapstoneDVCRemoteInput (+381 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (302): require_admin(), Dependency that requires admin privileges.      Checks if the current user has a, require_admin(), Test DELETE /admin/keys/{id} fails for non-admin users., Tests for POST /admin/users endpoint., Create a client with admin JWT token., Test creating a user with admin privileges., Test creating an admin user. (+294 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (331): _approval_record_evidence(), _approved_transfer_record_matches(), _artifact_checksum(), _artifact_entries_from_manifest_payload(), _artifact_reference_from_run(), _baseline_metric_value(), _best_artifact_from_training_manifest(), _bounded_training_blocked_result() (+323 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (274): Get session by ID, loading from database if not cached., List all sessions from database, optionally filtered by status., Delete a session from database and cache., Test updating session status with completion timestamp., Test updating step status with error message., Test recording multiple improvement attempts., Test adding a single artifact and verifying it persists., Test getting session by non-existent PK returns None. (+266 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (275): Tests for authentication method priority ordering., Test that API key auth is attempted before JWT when both are provided., Test that JWT is used when API key is invalid., Test APIKeyManager takes priority over APIKeyAuth hashed keys., Tests for Bearer token format handling., Test that 'Bearer' prefix is case-sensitive., Test Bearer token with extra spaces., Test Bearer token with only prefix, no token. (+267 more)

### Community 5 - "Community 5"
Cohesion: 0.01
Nodes (185): Agent Loop for MLOps Agent. Graph-based execution loop with self-improvement cap, Check if the circuit breaker is in open state., Get circuit breaker statistics., Main agent loop for MLOps operations.     Implements the Perception -> Decision, Load prompt from file., Emit an event to callback if registered., Load prompt from file., Load prompt from file. (+177 more)

### Community 6 - "Community 6"
Cohesion: 0.01
Nodes (182): Test that expired keys fail verification., Test that verification updates last_used_at., Test verification with required scope present., Test verification fails when required scope is missing., Tests for API key revocation., Test revoking a key by ID., Tests for API key generation., Test revoking a nonexistent key. (+174 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (184): Tests for MemorySearch class with database backend., Test initialization without database session., Test initialization with database session., Test loading sessions from empty database., Test loading sessions with data in database., Test that loaded session entries have correct structure., Tests for MemorySearch search methods., Test searching empty database. (+176 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (202): AgentLoop, Main agent loop for MLOps operations.     Implements the Perception -> Decision, Main agent loop for MLOps operations.     Implements the Perception -> Decision, Main agent loop for MLOps operations.     Implements the Perception -> Decision, Raised when a step execution fails., Raised when a step execution fails., Raised when a step execution fails., Raised when a step execution fails. (+194 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (152): ExperimentState, Check if accuracy threshold is met., Check if more improvement attempts are allowed., Get gap between current and target accuracy., Tracks the current ML experiment state., Test updating agent session timestamp., Test session_id uniqueness constraint., Test querying agent session by session_id. (+144 more)

### Community 10 - "Community 10"
Cohesion: 0.01
Nodes (212): AddWorkflowStepInput, analyze_project_config(), AnalyzeProjectConfigInput, call_tool(), CaptureLitserveLogsAndEndpointInput, CreateECRRepoInput, CreateGitHubWorkflowInput, CreateGradioInterfaceInput (+204 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (146): Context Manager for MLOps Agent - Graph-based execution tracking with experiment, get_model_manager(), ModelManager, Model Manager for MLOps Agent - LLM provider management. Supports multiple provi, Generate a response from the LLM with fallback chain support.          Args:, Manages LLM providers and model configurations.     Handles API calls with retry, Build the ordered list of models to try, starting from the specified model., Generate using Google Gemini. (+138 more)
...
Cohesion: 0.04
Nodes (111): Data Quality Module for MLOps Agent  Provides data profiling, validation, and qu, AnomalyDetectionResult, AnomalyRecord, AnomalyType, ColumnStatistics, DataQualityReport, DataSchema, DatasetStatistics (+103 more)

### Community 14 - "Community 14"
Cohesion: 0.02
Nodes (123): Validate a dataset against a defined schema.      Args:         dataset_path: Pa, Validate a dataset against a defined schema.      Args:         dataset_path: Pa, Validate a dataset against a defined schema.      Args:         dataset_path: Pa, Validate a dataset against a defined schema.      Args:         dataset_path: Pa, Validate a dataset against a defined schema.      Args:         dataset_path: Pa, Validate a dataset against a defined schema.      Args:         dataset_path: Pa, Validate a dataset against a defined schema.      Args:         dataset_path: Pa, Validate a dataset against a defined schema.      Args:         dataset_path: Pa (+115 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (103): Test password verification with empty password., Test that timestamps are set on creation., Tests for the APIKey SQLModel., Test basic API key creation., Test that default values are set correctly., Test API key generation., Test API key hashing., Test that different keys produce different hashes. (+95 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (118): APIKeyResponse, ApprovalRequest, CreateAPIKeyRequest, CreateAPIKeyResponse, CreateUserRequest, HealthResponse, Request model for running the agent., Get execution logs with pagination and filtering.      Parameters:     - page: P (+110 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (78): CIFAR10CNN, HuggingFaceTextDataset, CNN architecture optimized for CIFAR-10 (32x32 images).      Architecture:     -, Test model loading with custom parameters., Create a mock test data loader., Test that evaluate_model returns expected metrics., Test that accuracy is between 0 and 1., Tests for the DVC pipeline configuration file. (+70 more)

### Community 18 - "Community 18"
Cohesion: 0.02
Nodes (88): Capture explicit registry workflow evidence from a completed step result., Capture explicit registry workflow evidence from a completed step result., Validate selected registry approval gates before tool execution., Validate selected registry approval gates before tool execution., Check if the circuit breaker is in open state., Check if the circuit breaker is in open state., Check if the circuit breaker is in open state., Check if the circuit breaker is in open state. (+80 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (78): AgentSession, load(), load_sync(), Agent Session for MLOps Agent - Session management with experiment snapshots.  T, Mark session as completed., Serialize session to dictionary., Serialize session to JSON-compatible dict (alias for to_dict)., Save session to database asynchronously. (+70 more)

### Community 20 - "Community 20"
Cohesion: 0.02
Nodes (106): ConfigureLitserverInput, CreateHelmChartInput, CreateK8sConfigMapInput, CreateTorchserveHandlerInput, DetectGpuCudaInput, DetectRuntimeEnvironmentInput, GenerateIAMPolicyInput, GetECRLoginInput (+98 more)

### Community 21 - "Community 21"
Cohesion: 0.04
Nodes (61): Dataset, collate_fn(), create_data_loaders(), Create train and validation data loaders.      Returns:         Tuple of (train_, Dataset for text classification.      Args:         texts: List of text strings., Vocabulary for text tokenization.      Maintains mappings between words and indi, Collate function for DataLoader.      Pads sequences to the same length within a, Create train and test data loaders.      Args:         train_texts: List of trai (+53 more)

### Community 22 - "Community 22"
Cohesion: 0.03
Nodes (91): Raised when an operation exceeds its timeout., Execute an async operation with a timeout.      Usage:         result = await wi, TimeoutError, with_timeout(), bulkhead_config(), circuit_config(), Tests for CircuitBreaker class., Test creating a circuit breaker. (+83 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (65): Setup alerting configuration for model monitoring.      Creates alerting rules a, Setup alerting configuration for model monitoring.      Creates alerting rules a, Setup alerting configuration for model monitoring.      Creates alerting rules a, Setup alerting configuration for model monitoring.      Creates alerting rules a, Setup alerting configuration for model monitoring.      Creates alerting rules a, Setup alerting configuration for model monitoring.      Creates alerting rules a, Setup alerting configuration for model monitoring.      Creates alerting rules a, Setup alerting configuration for model monitoring.      Creates alerting rules a (+57 more)
...
Cohesion: 0.02
Nodes (89): Tests for StepExecutionError exception., Test creating StepExecutionError., Test StepExecutionError is an Exception., Test creating tracker with default values., Tests for StepExecutionError exception., Test creating StepExecutionError., Test StepExecutionError is an Exception., Test creating tracker with default values. (+81 more)

### Community 26 - "Community 26"
Cohesion: 0.02
Nodes (81): Run the self-improvement loop for training., Run the deployment workflow., Run the self-improvement loop for training., Run the self-improvement loop for training., Run the deployment workflow., Run the deployment workflow., Attempt to generate rollback instructions for a failed deployment., Attempt to generate rollback instructions for a failed deployment. (+73 more)

### Community 27 - "Community 27"
Cohesion: 0.03
Nodes (43): agent(), agent_with_event_handler(), _approved_transfer_record(), _evidence_by_check(), mock_agent(), mock_prompts_dir(), test_detect_capstone_data_layouts_blocks_empty_class_folder(), test_emit_handles_callback_error() (+35 more)

### Community 28 - "Community 28"
Cohesion: 0.03
Nodes (81): create_api_key(), create_log(), create_user(), generate_demo_metrics(), get_agent_metrics(), get_logs(), get_metrics(), get_pipeline_metrics() (+73 more)

### Community 29 - "Community 29"
Cohesion: 0.03
Nodes (65): monitor_model_performance(), Monitor model performance metrics and detect degradation.      Uses the ModelMon, Monitor model performance metrics and detect degradation.      Uses the ModelMon, Monitor model performance metrics and detect degradation.      Uses the ModelMon, Monitor model performance metrics and detect degradation.      Uses the ModelMon, Monitor model performance metrics and detect degradation.      Uses the ModelMon, Monitor model performance metrics and detect degradation.      Uses the ModelMon, Monitor model performance metrics and detect degradation.      Uses the ModelMon (+57 more)

### Community 30 - "Community 30"
Cohesion: 0.03
Nodes (54): Mark a step as failed and record error., Attach summarizer output to session memory., anomaly_csv(), current_csv(), drifted_csv(), dvc_remote_path(), mlflow_session(), mlflow_tracking_uri() (+46 more)

### Community 31 - "Community 31"
Cohesion: 0.03
Nodes (62): approve_action(), get_session_details(), get_session_status(), run_agent(), run_agent_session(), SessionManager, websocket_endpoint(), Test getting a non-existent session. (+54 more)
...
Cohesion: 0.04
Nodes (53): detect_data_drift(), Detect data drift between reference and current datasets using Evidently AI., Detect data drift between reference and current datasets using Evidently AI., Detect data drift between reference and current datasets using Evidently AI., Detect data drift between reference and current datasets using Evidently AI., Detect data drift between reference and current datasets using Evidently AI., Detect data drift between reference and current datasets using Evidently AI., Detect data drift between reference and current datasets using Evidently AI. (+45 more)
...
Cohesion: 0.04
Nodes (52): create_cifar10_loaders(), create_synthetic_data(), get_cifar10_transforms(), get_transforms(), ImageClassificationDataset, Dataset utilities for tabular regression., Create synthetic regression data for testing.      Args:         n_samples: Numb, Create synthetic dataset for testing.      Creates random colored images for eac (+44 more)

### Community 37 - "Community 37"
Cohesion: 0.05
Nodes (44): Wrapper class for tabular regression inference., Initialize the regressor.          Args:             model_path: Path to model c, TabularRegressor, GLUBlock, load_model(), MLP, Model architectures for tabular regression., Multi-Layer Perceptron for tabular regression.      A feedforward neural network (+36 more)
...
Cohesion: 0.05
Nodes (62): CircuitBreaker, CircuitBreakerConfig, CircuitBreakerRegistry, Decorator for protecting async functions., Registry for managing multiple circuit breakers.      Usage:         registry =, Get existing or create new circuit breaker., Get circuit breaker by name., Get statistics for all circuit breakers. (+54 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (48): alert_config(), manager(), monitor(), Unit tests for the monitoring module.  Tests drift detection, model monitoring,, Test FeatureDriftResult with distribution data., Tests for HealthStatus enum., Test HealthStatus enum values., Tests for ModelMetrics model. (+40 more)
...
Cohesion: 0.03
Nodes (69): CompareDistributionsInput, CreateExpectationSuiteInput, CreateInferenceServiceYAMLInput, CreateK8sIngressInput, GenerateLitserveDockerfileInput, ProfileDatasetInput, Start LitServe server in the current project environment., Start LitServe server in the current project environment. (+61 more)
...
Cohesion: 0.05
Nodes (36): create_model(), Factory function to create a model by type.      Args:         model_type: One o, Create a text classification model.      Args:         model_type: Type of model, Create and return a ResNet18 model.      Args:         num_classes: Number of ou, ResNet18 for image classification.      Supports both CIFAR-10 (32x32) and Image, ResNet18, Test model works with various batch sizes., Test that pretrained model has correct structure. (+28 more)
...
Cohesion: 0.04
Nodes (34): HTTPException, Tests for input validation., Test successful path validation., Test path traversal detection., Test path validation with base path restriction., Test empty path validation., Test string sanitization., Test string length truncation. (+26 more)

### Community 47 - "Community 47"
Cohesion: 0.07
Nodes (56): test_build_capstone_pipeline_declares_orchestrator_skeleton(), test_container_build_failure_is_failed_contract_evidence(), test_container_local_ready_build_conditions_follow_docker_availability(), test_declared_endpoint_evidence_does_not_satisfy_litserve_gpu_contract(), test_declared_evidence_does_not_satisfy_observed_contract_check(), test_deploy_gpu_inference_declares_backend_branches(), test_deploy_litserve_gpu_requires_observed_runtime_evidence(), test_deployment_templates_are_non_fake_ordered_templates() (+48 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (37): Validate ML dataset for quality issues.      Performs various data quality check, Validate ML dataset for quality issues.      Performs various data quality check, Validate ML dataset for quality issues.      Performs various data quality check, Validate ML dataset for quality issues.      Performs various data quality check, Validate ML dataset for quality issues.      Performs various data quality check, Validate ML dataset for quality issues.      Performs various data quality check, Validate ML dataset for quality issues.      Performs various data quality check, validate_dataset() (+29 more)

### Community 49 - "Community 49"
Cohesion: 0.04
Nodes (51): Test should_continue when at limit., Test should_continue when at limit., Tests for AgentLoop routing logic., Test _should_summarize returns True when route is summarize., Test _needs_improvement returns True when below threshold., Test should_continue when at limit., Tests for AgentLoop routing logic., Test _should_summarize returns True when route is summarize. (+43 more)
...
Cohesion: 0.04
Nodes (47): create_hydra_config(), Call the LitServe health endpoint and record observed evidence., Create KServe InferenceService YAML., Create Kubernetes Deployment YAML., Validate Hydra configuration., Update existing Hydra configuration., Validate Hydra configuration., Create Hydra configuration structure. (+39 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (31): create_dataloaders(), load_data(), PyTorch Dataset for tabular regression data., Initialize dataset.          Args:             features: Feature matrix of shape, Load data from CSV files.      Args:         data_dir: Directory containing trai, TabularDataset, Tabular Regression Example for Auto-MLOps., Tests for TabularDataset class. (+23 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (32): Bulkhead, BulkheadConfig, BulkheadFullError, BulkheadRegistry, BulkheadStats, Bulkhead Pattern Implementation.  Provides resource isolation to prevent cascadi, Try to acquire a permit without blocking., Acquire a permit from the bulkhead.          Raises:             BulkheadFullErr (+24 more)

### Community 55 - "Community 55"
Cohesion: 0.05
Nodes (28): Perception module for MLOps Agent. ML pipeline awareness and intent understandin, build_perception_input(), Perception Module for MLOps Agent. Analyzes ML pipeline context and routes to ap, Build input for perception module.      Args:         query: User query, Tests for build_perception_input function., Test that build_perception_input returns correct structure., Test that build_perception_input includes available tools., Test that build_perception_input uses context state. (+20 more)

### Community 56 - "Community 56"
Cohesion: 0.07
Nodes (32): create_expectation_suite(), Create a Great Expectations expectation suite for data validation.      Creates, Create a Great Expectations expectation suite for data validation.      Creates, Create a Great Expectations expectation suite for data validation.      Creates, Create a Great Expectations expectation suite for data validation.      Creates, Create a Great Expectations expectation suite for data validation.      Creates, Create a Great Expectations expectation suite for data validation.      Creates, Create a Great Expectations expectation suite for data validation.      Creates (+24 more)
...
Cohesion: 0.05
Nodes (22): mock_context_manager(), mock_prompts_dir(), perception(), Test normalization adds all required fields when missing., Test normalization sets correct default values., Test normalization preserves valid existing fields., Test normalization corrects invalid route value., Test all valid routes are preserved. (+14 more)
...
Cohesion: 0.07
Nodes (39): add_data_to_dvc(), build_ml_docker_image(), check_tool_installed(), configure_dvc_remote(), detect_gpu_cuda(), dvc_pull(), dvc_push(), dvc_reproduce() (+31 more)

### Community 61 - "Community 61"
Cohesion: 0.05
Nodes (44): CheckDataQualityInput, CreateFastAPIAppInput, CreateLambdaDockerfileInput, DetectAnomaliesInput, GenerateTorchserveConfigInput, Create FastAPI application for model serving., Call the LitServe health endpoint and record observed evidence., Generate TorchServe configuration. (+36 more)

### Community 62 - "Community 62"
Cohesion: 0.05
Nodes (42): Test _load_prompt returns empty string for missing file., Test _load_prompt returns empty string for missing file., Tests for AgentLoop _pick_next_step method., Test _load_prompt returns empty string for missing file., Test _pick_next_step returns None when all completed., Tests for AgentLoop routing logic., Integration tests for AgentLoop.run method., Tests for AgentLoop _pick_next_step method. (+34 more)

### Community 63 - "Community 63"
Cohesion: 0.05
Nodes (32): Select a registry workflow before prompt-authored planning., Select a registry workflow before prompt-authored planning., Select a registry workflow before prompt-authored planning., Select a registry workflow before prompt-authored planning., Return the first setup_pipeline approval gate that lacks approval., Keep broad multi-phase requests on the prompt-authored planning path., Keep broad multi-phase requests on the prompt-authored planning path., Return a deterministic question for missing workflow inputs. (+24 more)
...
Cohesion: 0.05
Nodes (40): capture_litserve_logs_and_endpoint(), list_tools(), Record the Capstone Orchestrator skeleton without faking full capstone success., Record endpoint URL and server log location as observed deployment evidence., List all available MLOps tools., Record the Capstone Orchestrator skeleton without faking full capstone success., Record the Capstone Orchestrator skeleton without faking full capstone success., Record the Capstone Orchestrator skeleton without faking full capstone success. (+32 more)
...
Cohesion: 0.1
Nodes (39): lifespan(), Lifespan context manager for startup/shutdown., close_async_db(), get_async_engine(), get_async_session_factory(), init_async_db(), Get or create async SQLAlchemy engine singleton.      Creates appropriate engine, Get or create async session factory singleton.      Returns:         Async SQLAl (+31 more)

### Community 75 - "Community 75"
Cohesion: 0.08
Nodes (28): profile_dataset(), Profile a dataset to get comprehensive statistics.      Args:         dataset_pa, Profile a dataset to get comprehensive statistics.      Args:         dataset_pa, Profile a dataset to get comprehensive statistics.      Args:         dataset_pa, Profile a dataset to get comprehensive statistics.      Args:         dataset_pa, Profile a dataset to get comprehensive statistics.      Args:         dataset_pa, Profile a dataset to get comprehensive statistics.      Args:         dataset_pa, Profile a dataset to get comprehensive statistics.      Args:         dataset_pa (+20 more)

### Community 76 - "Community 76"
Cohesion: 0.05
Nodes (38): create_ml_dockerfile(), dvc_pull(), dvc_reproduce(), generate_litserve_dockerfile(), Pull data from DVC remote., Reproduce DVC pipeline., Create Dockerfile for ML project., Pull data from DVC remote. (+30 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (39): create_gradio_interface(), detect_gpu_cuda(), Create Gradio interface for model demo., Create Gradio interface for model demo., Create Gradio interface for model demo., Create Gradio interface for model demo., Create Gradio interface for model demo., Create Gradio interface for model demo. (+31 more)

### Community 78 - "Community 78"
Cohesion: 0.08
Nodes (29): test_registry_rejects_fake_templates(), _approval_gate_for_step(), _approval_record_matches_gate(), _artifact_matches_requirement(), _artifact_requirement_satisfied(), _artifact_requirements_for_check(), _contract_check_condition_applies(), _evidence_satisfies_check() (+21 more)
...
Cohesion: 0.07
Nodes (27): api_key_auth(), config_with_keys(), full_config(), jwt_auth(), jwt_config(), manager(), rate_config(), rate_limiter() (+19 more)
...
Cohesion: 0.07
Nodes (22): async_search_past_experiments(), index_data(), Memory Search Module for MLOps Agent. Searches past experiment sessions for rele, Simple substring-based search fallback., Search for sessions with best metrics.          Args:             metric_name: M, Search for sessions with specific configuration.          Args:             conf, Load all session logs from database asynchronously., Explicitly load session data from database. (+14 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (36): CreateK8sDeploymentInput, CreateK8sHPAInput, CreateK8sServiceInput, DeployToHuggingfaceInput, MonitorModelPerformanceInput, Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces. (+28 more)
...
Cohesion: 0.08
Nodes (26): create_cifar10_loaders(), create_huggingface_tokenizer(), get_cifar10_transforms(), load_imdb_huggingface(), main(), Main training function.      Args:         cfg: Hydra configuration         trai, Get CIFAR-10 transforms for training and validation., Main training function.      Returns:         dict with training results includi (+18 more)
...
Cohesion: 0.06
Nodes (32): Tests for AgentLoop initialization., Test creating AgentLoop with event callback., Tests for AgentLoop initialization., Tests for StepExecutionError exception., Tests for AgentLoop initialization., Test creating AgentLoop with event callback., Test creating AgentLoop with custom tools module., Tests for AgentLoop initialization. (+24 more)

### Community 93 - "Community 93"
Cohesion: 0.06
Nodes (31): Test ROOT step type constant., Test ROOT step type constant., Test ROOT step type constant., Test that _initialize_session initializes placeholders., Test should_continue when within limits., Test _pick_next_step skips completed steps., Test ROOT step type constant., Test ROOT step type constant. (+23 more)

### Community 94 - "Community 94"
Cohesion: 0.07
Nodes (22): Timeout Management for Async Operations.  Provides configurable timeouts for asy, Record a timed out call., Decorator for adding timeout to async functions., Context manager for timeout operations.      Usage:         async with TimeoutCo, Enter the timeout context., Exit the timeout context., Decorator for adding timeout to async functions.      Usage:         @timeout(30, Configuration for timeout behavior. (+14 more)

### Community 95 - "Community 95"
Cohesion: 0.13
Nodes (19): Colors, main(), print_header(), print_test(), Run all tests or filtered tests., Clean up test directory., Test Hydra configuration tools., Test MLflow experiment tracking tools. (+11 more)
...
Cohesion: 0.06
Nodes (31): Tests for StepExecutionTracker class., Test creating tracker with custom values., Tests for StepExecutionTracker class., Test creating tracker with custom values., Tests for StepExecutionTracker class., Test creating tracker with custom values., Tests for StepExecutionTracker class., Test creating tracker with custom values. (+23 more)

### Community 98 - "Community 98"
Cohesion: 0.06
Nodes (30): Tests for StepType constants., Test IMPROVE step type constant., Tests for StepType constants., Test IMPROVE step type constant., Tests for StepType constants., Test IMPROVE step type constant., Test _load_prompt returns file content., Tests for StepType constants. (+22 more)

### Community 99 - "Community 99"
Cohesion: 0.06
Nodes (29): Test CODE step type constant., Test CODE step type constant., Test CODE step type constant., Test creating AgentLoop with default values., Test creating AgentLoop with default values., Test _pick_next_step returns first pending step., Test CODE step type constant., Tests for StepType constants. (+21 more)

### Community 100 - "Community 100"
Cohesion: 0.07
Nodes (31): add_data_to_dvc(), build_ml_docker_image(), check_tool_installed(), Add data to DVC tracking., Add data to DVC tracking., Add data to DVC tracking., Build Docker image for ML project., Add data to DVC tracking. (+23 more)
...
Cohesion: 0.09
Nodes (19): _get_tool_params(), Get parameter names for a function., Get parameter names for a function., Initialize the API key manager with in-memory storage., test_detect_training_project_blocks_ambiguous_entrypoints(), test_detect_training_project_recognizes_session_06_shape(), test_run_detect_training_project_succeeds_from_supported_detection(), test_run_train_and_track_blocks_missing_bounded_controls() (+11 more)

### Community 103 - "Community 103"
Cohesion: 0.11
Nodes (17): get_cors_origins(), get_cors_origins(), Get CORS origins from environment variable.      Returns a list of allowed origi, Tests that CORS middleware is properly configured., Test that CORSMiddleware is added to the app., Tests for get_cors_origins function., Test that default (unset env var) returns ['*']., Test that empty string returns ['*']. (+9 more)
...
Cohesion: 0.07
Nodes (28): dvc_push(), init_dvc_repo(), Create a Helm chart for Kubernetes deployment., Start a new MLflow run., Initialize DVC in a repository., Start a new MLflow run., Start a new MLflow run., Start a new MLflow run. (+20 more)
...
Cohesion: 0.11
Nodes (21): load_imdb_data(), Load IMDB movie review dataset from local directory.      Expects directory stru, compute_metrics(), evaluate(), evaluate_model(), get_test_transforms(), load_model(), load_model_for_eval() (+13 more)
...
Cohesion: 0.08
Nodes (23): Return setup artifact manifest entries explicitly reported by a step., Return verification records explicitly reported by a registry step., Return artifact manifest entries explicitly reported by a registry step., Return verification records explicitly reported by a registry step., Return artifact manifest entries explicitly reported by a registry step., Return verification records explicitly reported by a registry step., Return verification records explicitly reported by a registry step., Return artifact manifest entries explicitly reported by a registry step. (+15 more)

### Community 111 - "Community 111"
Cohesion: 0.08
Nodes (25): _capstone_dvc_tracking_result(), _capstone_package_paths_from_split_records(), _configure_capstone_dvc_remote(), _ensure_local_dvc_repo(), push_docker_image(), Push Docker image to registry., Push Docker image to registry., Push Docker image to registry. (+17 more)

### Community 112 - "Community 112"
Cohesion: 0.08
Nodes (18): Tests for AVAILABLE_TOOLS constant., Test AVAILABLE_TOOLS contains Hydra tools., Test AVAILABLE_TOOLS contains MLflow tools., Test AVAILABLE_TOOLS contains DVC tools., Test AVAILABLE_TOOLS contains Docker tools., Test AVAILABLE_TOOLS contains Docker tools., Test AVAILABLE_TOOLS contains GitHub Actions tools., Test AVAILABLE_TOOLS contains GitHub Actions tools. (+10 more)
...
Cohesion: 0.08
Nodes (23): Get improvement suggestions from LLM., Run the MLOps agent with a query.      Args:         query: User query (e.g., "S, Get improvement suggestions from LLM., Run the MLOps agent with a query.      Args:         query: User query (e.g., "S, Get improvement suggestions from LLM., Run the MLOps agent with a query.      Args:         query: User query (e.g., "S, Get improvement suggestions from LLM., Run the MLOps agent with a query.      Args:         query: User query (e.g., "S (+15 more)
...
Cohesion: 0.08
Nodes (22): Test _should_summarize returns False when not achieved., Test _should_summarize returns False when not achieved., Test _needs_deployment returns False when not deploying., Test error message format., Test _needs_deployment returns False when not deploying., Test _should_summarize returns False when not achieved., Test _needs_deployment returns False when not deploying., Test _needs_deployment returns False when not deploying. (+14 more)

### Community 120 - "Community 120"
Cohesion: 0.08
Nodes (24): create_mar_archive(), Create TorchServe MAR (Model Archive) file., Create TorchServe MAR (Model Archive) file., Create TorchServe MAR (Model Archive) file., Create TorchServe MAR (Model Archive) file., Create TorchServe MAR (Model Archive) file., Create TorchServe MAR (Model Archive) file., Create TorchServe MAR (Model Archive) file. (+16 more)
...
Cohesion: 0.09
Nodes (21): Test getting circuit stats., Test getting circuit stats., Test has_exceeded_retries when within limit., Test getting circuit stats., Test _needs_improvement returns False when no accuracy recorded., Test getting circuit stats., Test _needs_improvement returns False when no accuracy recorded., Test getting circuit stats. (+13 more)

### Community 124 - "Community 124"
Cohesion: 0.09
Nodes (21): Test retry step ID generation with failures., Test retry step ID generation with failures., Test _should_summarize returns True when goal achieved., Test retry step ID generation with failures., Test _should_summarize returns True when goal achieved., Test retry step ID generation with failures., Test retry step ID generation with failures., Test incrementing tries counter. (+13 more)

### Community 125 - "Community 125"
Cohesion: 0.09
Nodes (21): Test DECISION route constant., Test DECISION route constant., Test circuit breaker property access., Test DECISION route constant., Test circuit breaker property access., Test DECISION route constant., Test DECISION route constant., Test circuit breaker property access. (+13 more)

### Community 126 - "Community 126"
Cohesion: 0.09
Nodes (21): Test recording step failures., Test recording step failures., Test recording step failures., Test has_exceeded_retries when within limit., Test has_exceeded_retries when within limit., Test recording step failures., Test recording step failures., Test recording step failures. (+13 more)
...
Cohesion: 0.09
Nodes (20): Test IMPROVE route constant., Test IMPROVE route constant., Test creating AgentLoop with custom profile., Test IMPROVE route constant., Test creating AgentLoop with custom profile., Test creating AgentLoop with custom profile., Test IMPROVE route constant., Test creating AgentLoop with custom profile. (+12 more)

### Community 132 - "Community 132"
Cohesion: 0.09
Nodes (20): Test should_continue when within limits., Test should_continue when within limits., Test should_continue when within limits., Test _needs_deployment returns True when route is deploy., Test _needs_deployment returns True when route is deploy., Test _needs_deployment returns True when route is deploy., Test should_continue when within limits., Test should_continue when within limits. (+12 more)
...
Cohesion: 0.1
Nodes (20): Tests for Route constants., Test SUMMARIZE route constant., Test SUMMARIZE route constant., Tests for Route constants., Test SUMMARIZE route constant., Tests for Route constants., Test SUMMARIZE route constant., Test SUMMARIZE route constant. (+12 more)

### Community 136 - "Community 136"
Cohesion: 0.1
Nodes (20): create_litserve_api(), load_template(), Load a template file., Create LitServe API for model serving., Load a template file., Create LitServe API for model serving., Load a template file., Create LitServe API for model serving. (+12 more)

### Community 137 - "Community 137"
Cohesion: 0.11
Nodes (17): get_available_tools(), Get list of available MLOps tools., Get list of available MLOps tools., Get list of available MLOps tools., Get list of available MLOps tools., Get list of available MLOps tools., Get list of available MLOps tools., Get list of available MLOps tools. (+9 more)
...
Cohesion: 0.11
Nodes (19): get_best_mlflow_run(), Register model in MLflow Model Registry., Get best run from experiment based on metric., Register model in MLflow Model Registry., Get best run from experiment based on metric., Log metrics to MLflow., Get best run from experiment based on metric., Register model in MLflow Model Registry. (+11 more)

### Community 144 - "Community 144"
Cohesion: 0.11
Nodes (19): configure_dvc_remote(), create_dvc_pipeline(), Configure DVC remote storage., Create DVC pipeline (dvc.yaml)., Configure DVC remote storage., Create DVC pipeline (dvc.yaml)., Configure DVC remote storage., Configure DVC remote storage. (+11 more)
...
Cohesion: 0.11
Nodes (18): log_mlflow_metrics(), log_mlflow_params(), Log parameters to MLflow., Log metrics to MLflow., Log parameters to MLflow., Log metrics to MLflow., Log parameters to MLflow., Log metrics to MLflow. (+10 more)
...
Cohesion: 0.13
Nodes (14): Suggest improvements based on training results., Suggest improvements based on training results., Suggest improvements based on training results., Suggest improvements based on training results., Suggest improvements based on training results., Suggest improvements based on training results., Suggest improvements based on training results., Suggest improvements based on training results. (+6 more)
...
Cohesion: 0.12
Nodes (9): Test paths config loads and has required fields., Test baseline experiment config loads., Test high_accuracy experiment config loads., Tests for sklearn config content validity., Test that main config loads without error., Test Ridge config loads and has required fields., Test GradientBoosting config loads and has required fields., Test training config loads and has required fields. (+1 more)

### Community 164 - "Community 164"
Cohesion: 0.13
Nodes (15): Update kubeconfig for an EKS cluster using AWS CLI., Update kubeconfig for an EKS cluster using AWS CLI., Update kubeconfig for an EKS cluster using AWS CLI., Update kubeconfig for an EKS cluster using AWS CLI., Update kubeconfig for an EKS cluster using AWS CLI., Update kubeconfig for an EKS cluster using AWS CLI., Update kubeconfig for an EKS cluster using AWS CLI., Update kubeconfig for an EKS cluster using AWS CLI. (+7 more)
...
Cohesion: 0.13
Nodes (15): Rollback a Kubernetes deployment using kubectl., Rollback a Kubernetes deployment using kubectl., Rollback a Kubernetes deployment using kubectl., Rollback a Kubernetes deployment using kubectl., Rollback a Kubernetes deployment using kubectl., Rollback a Kubernetes deployment using kubectl., Rollback a Kubernetes deployment using kubectl., Rollback a Kubernetes deployment using kubectl. (+7 more)

### Community 167 - "Community 167"
Cohesion: 0.13
Nodes (15): Rollback a deployment based on target type., Rollback a deployment based on target type., Rollback a deployment based on target type., Rollback a deployment based on target type., Rollback a deployment based on target type., Rollback a deployment based on target type., Rollback a deployment based on target type., Rollback a deployment based on target type. (+7 more)

### Community 168 - "Community 168"
Cohesion: 0.13
Nodes (15): generate_torchserve_config(), Generate TorchServe configuration., Generate TorchServe configuration., Generate TorchServe configuration., Generate TorchServe configuration., Generate TorchServe configuration., Generate TorchServe configuration., Generate TorchServe configuration. (+7 more)

### Community 169 - "Community 169"
Cohesion: 0.13
Nodes (15): create_helm_chart(), Create a Helm chart for Kubernetes deployment., Create a Helm chart for Kubernetes deployment., Create a Helm chart for Kubernetes deployment., Create a Helm chart for Kubernetes deployment., Create a Helm chart for Kubernetes deployment., Create a Helm chart for Kubernetes deployment., Create a Helm chart for Kubernetes deployment. (+7 more)
...
Cohesion: 0.13
Nodes (15): create_k8s_hpa_yaml(), Create Kubernetes HPA YAML., Create Kubernetes HPA YAML., Create Kubernetes HPA YAML., Create Kubernetes HPA YAML., Create Kubernetes HPA YAML., Create Kubernetes HPA YAML., Create Kubernetes HPA YAML. (+7 more)
...
Cohesion: 0.13
Nodes (15): create_inference_service_yaml(), Create KServe InferenceService YAML., Create KServe InferenceService YAML., Create KServe InferenceService YAML., Create KServe InferenceService YAML., Create KServe InferenceService YAML., Create KServe InferenceService YAML., Create KServe InferenceService YAML. (+7 more)

### Community 176 - "Community 176"
Cohesion: 0.13
Nodes (15): create_k8s_service_yaml(), Create Kubernetes Service YAML., Create Kubernetes Service YAML., Create Kubernetes Service YAML., Create Kubernetes Service YAML., Create Kubernetes Service YAML., Create Kubernetes Service YAML., Create Kubernetes Service YAML. (+7 more)

### Community 177 - "Community 177"
Cohesion: 0.13
Nodes (15): generate_rollback_plan(), Generate a rollback plan with suggested commands., Generate a rollback plan with suggested commands., Generate a rollback plan with suggested commands., Generate a rollback plan with suggested commands., Generate a rollback plan with suggested commands., Generate a rollback plan with suggested commands., Generate a rollback plan with suggested commands. (+7 more)

### Community 178 - "Community 178"
Cohesion: 0.13
Nodes (15): create_k8s_secret_yaml(), Create Kubernetes Secret YAML., Create Kubernetes Secret YAML., Create Kubernetes Secret YAML., Create Kubernetes Secret YAML., Create Kubernetes Secret YAML., Create Kubernetes Secret YAML., Create Kubernetes Secret YAML. (+7 more)

### Community 179 - "Community 179"
Cohesion: 0.13
Nodes (15): estimate_deployment_cost(), Estimate monthly cost for basic deployment usage., Estimate monthly cost for basic deployment usage., Estimate monthly cost for basic deployment usage., Estimate monthly cost for basic deployment usage., Estimate monthly cost for basic deployment usage., Estimate monthly cost for basic deployment usage., Estimate monthly cost for basic deployment usage. (+7 more)

### Community 181 - "Community 181"
Cohesion: 0.13
Nodes (14): Test AVAILABLE_TOOLS has expected number of tools., Test AVAILABLE_TOOLS has expected number of tools., Test AVAILABLE_TOOLS has expected number of tools., Test AVAILABLE_TOOLS has expected number of tools., Test AVAILABLE_TOOLS has expected number of tools., Test AVAILABLE_TOOLS has expected number of tools., Test AVAILABLE_TOOLS has expected number of tools., Integration-style tests for execute_step. (+6 more)
...
Cohesion: 0.13
Nodes (15): deploy_to_huggingface(), Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces. (+7 more)

### Community 184 - "Community 184"
Cohesion: 0.13
Nodes (15): create_lambda_dockerfile(), Create Dockerfile for AWS Lambda deployment., Create Dockerfile for AWS Lambda deployment., Create Dockerfile for AWS Lambda deployment., Create Dockerfile for AWS Lambda deployment., Create Dockerfile for AWS Lambda deployment., Create Dockerfile for AWS Lambda deployment., Create Dockerfile for AWS Lambda deployment. (+7 more)

### Community 185 - "Community 185"
Cohesion: 0.13
Nodes (15): create_k8s_configmap_yaml(), Create Kubernetes ConfigMap YAML., Create Kubernetes ConfigMap YAML., Create Kubernetes ConfigMap YAML., Create Kubernetes ConfigMap YAML., Create Kubernetes ConfigMap YAML., Create Kubernetes ConfigMap YAML., Create Kubernetes ConfigMap YAML. (+7 more)
...
Cohesion: 0.14
Nodes (14): Call /predict and record observed HTTP evidence., Call /predict and record observed HTTP evidence., Call /predict and record observed HTTP evidence., Call /predict and record observed HTTP evidence., Call /predict and record observed HTTP evidence., Call /predict and record observed HTTP evidence., Call /predict and record observed HTTP evidence., Call /predict and record observed HTTP evidence. (+6 more)

### Community 190 - "Community 190"
Cohesion: 0.14
Nodes (14): Record process cleanup and manual Lambda Cloud stop instructions., Record process cleanup and manual Lambda Cloud stop instructions., Record process cleanup and manual Lambda Cloud stop instructions., Record process cleanup and manual Lambda Cloud stop instructions., Record process cleanup and manual Lambda Cloud stop instructions., Record process cleanup and manual Lambda Cloud stop instructions., Record process cleanup and manual Lambda Cloud stop instructions., Record process cleanup and manual Lambda Cloud stop instructions. (+6 more)

### Community 191 - "Community 191"
Cohesion: 0.14
Nodes (14): create_torchserve_handler(), Create TorchServe custom handler., Create TorchServe custom handler., Create TorchServe custom handler., Create TorchServe custom handler., Create TorchServe custom handler., Create TorchServe custom handler., Create TorchServe custom handler. (+6 more)

### Community 192 - "Community 192"
Cohesion: 0.14
Nodes (14): create_k8s_ingress_yaml(), Create Kubernetes Ingress YAML (ALB annotations for EKS)., Create Kubernetes Ingress YAML (ALB annotations for EKS)., Create Kubernetes Ingress YAML (ALB annotations for EKS)., Create Kubernetes Ingress YAML (ALB annotations for EKS)., Create TorchServe custom handler., Create Kubernetes Ingress YAML (ALB annotations for EKS)., Create Kubernetes Ingress YAML (ALB annotations for EKS). (+6 more)

### Community 193 - "Community 193"
Cohesion: 0.14
Nodes (14): generate_iam_policy(), Generate a least-privilege IAM policy document., Generate a least-privilege IAM policy document., Generate a least-privilege IAM policy document., Generate a least-privilege IAM policy document., Generate a least-privilege IAM policy document., Generate a least-privilege IAM policy document., Generate a least-privilege IAM policy document. (+6 more)

### Community 194 - "Community 194"
Cohesion: 0.14
Nodes (14): get_ecr_login(), Get ECR login command., Get ECR login command., Get ECR login command., Get ECR login command., Get ECR login command., Get ECR login command., Get ECR login command. (+6 more)

### Community 195 - "Community 195"
Cohesion: 0.14
Nodes (14): create_ecr_repo(), _ensure_boto3(), Create or get an ECR repository., Create or get an ECR repository., Create or get an ECR repository., Create or get an ECR repository., Create or get an ECR repository., Create or get an ECR repository. (+6 more)

### Community 196 - "Community 196"
Cohesion: 0.14
Nodes (14): Call /health and record observed HTTP evidence., Call /health and record observed HTTP evidence., Call /health and record observed HTTP evidence., Call /health and record observed HTTP evidence., Call /health and record observed HTTP evidence., Call /health and record observed HTTP evidence., Call /health and record observed HTTP evidence., Call /health and record observed HTTP evidence. (+6 more)

### Community 197 - "Community 197"
Cohesion: 0.14
Nodes (14): generate_cdk_stack(), Generate AWS CDK stack for Lambda deployment., Generate AWS CDK stack for Lambda deployment., Generate AWS CDK stack for Lambda deployment., Generate AWS CDK stack for Lambda deployment., Generate AWS CDK stack for Lambda deployment., Generate AWS CDK stack for Lambda deployment., Generate AWS CDK stack for Lambda deployment. (+6 more)
...
Cohesion: 0.14
Nodes (8): Tests that verify endpoints have the rate limit decorator., Verify /health endpoint has request parameter for rate limiting., Verify /status/{session_id} endpoint has request parameter., Verify /sessions/{session_id} endpoint has request parameter., Verify /metrics/agent endpoint has request parameter., Verify GET /logs endpoint has request parameter., Verify POST /admin/keys endpoint has request parameter., TestEndpointHasRateLimitDecorator
...
Cohesion: 0.15
Nodes (12): create_github_workflow(), Create GitHub Actions workflow for ML pipeline., Create GitHub Actions workflow for ML pipeline., Create GitHub Actions workflow for ML pipeline., Create GitHub Actions workflow for ML pipeline., Create GitHub Actions workflow for ML pipeline., Create GitHub Actions workflow for ML pipeline., Create GitHub Actions workflow for ML pipeline. (+4 more)

### Community 211 - "Community 211"
Cohesion: 0.15
Nodes (13): Record that Docker image build is optional and skipped by default., Record that Docker image build is optional and skipped by default., Record that Docker image build is optional and skipped by default., Record that Docker image build is optional and skipped by default., Record that Docker image build is optional and skipped by default., Record that Docker image build is optional and skipped by default., Record that Docker image build is optional and skipped by default., Write durable Phase 4 data-stage evidence for capstone handoff. (+5 more)

### Community 212 - "Community 212"
Cohesion: 0.15
Nodes (13): Start LitServe server and record observed process evidence., Start LitServe server and record observed process evidence., Start LitServe server and record observed process evidence., Start LitServe server and record observed process evidence., Start LitServe server and record observed process evidence., Start LitServe server and record observed process evidence., Start LitServe server and record observed process evidence., Start LitServe server and record observed process evidence. (+5 more)

### Community 213 - "Community 213"
Cohesion: 0.15
Nodes (13): ensure_directory(), Select or create a local model artifact for LitServe preflight., Select or create a local model artifact for LitServe preflight., Ensure directory exists and return Path object., Select or create a local model artifact for LitServe preflight., Select or create a local model artifact for LitServe preflight., Select or create a local model artifact for LitServe preflight., Select or create a local model artifact for LitServe preflight. (+5 more)

### Community 214 - "Community 214"
Cohesion: 0.15
Nodes (13): generate_kserve_config(), Generate KServe configuration., Generate KServe configuration., Generate KServe configuration., Generate KServe configuration., Generate KServe configuration., Generate KServe configuration., Generate KServe configuration. (+5 more)

### Community 215 - "Community 215"
Cohesion: 0.15
Nodes (13): Select an existing model artifact or preflight artifact for LitServe deployment., Select a model artifact for deterministic training comparison or LitServe deploy, Select a model artifact for deterministic training comparison or LitServe deploy, Select a model artifact for deterministic training comparison or LitServe deploy, Select a model artifact for deterministic training comparison or LitServe deploy, Select a model artifact for deterministic training comparison or LitServe deploy, Select a model artifact for deterministic training comparison or LitServe deploy, Select a model artifact for deterministic training comparison or LitServe deploy (+5 more)

### Community 216 - "Community 216"
Cohesion: 0.15
Nodes (12): Test has_exceeded_retries when at limit., Test has_exceeded_retries when at limit., Test has_exceeded_retries when at limit., Test has_exceeded_retries when at limit., Test has_exceeded_retries when at limit., Test has_exceeded_retries when at limit., Test should_continue when within limits., Test has_exceeded_retries when at limit. (+4 more)

### Community 217 - "Community 217"
Cohesion: 0.15
Nodes (12): Test circuit is initially closed., Test circuit is initially closed., Test circuit is initially closed., Test circuit is initially closed., Test should_continue when within limits., Test circuit is initially closed., Test circuit is initially closed., Test circuit is initially closed. (+4 more)

### Community 218 - "Community 218"
Cohesion: 0.15
Nodes (12): Test retry step ID with no failures., Test retry step ID with no failures., Test retry step ID with no failures., Test retry step ID with no failures., Test retry step ID with no failures., Test retry step ID with no failures., Test retry step ID with no failures., Test retry step ID with no failures. (+4 more)
...
Cohesion: 0.17
Nodes (11): Test resetting circuit breaker., Test resetting circuit breaker., Test resetting circuit breaker., Test resetting circuit breaker., Test resetting circuit breaker., Test resetting circuit breaker., Test resetting circuit breaker., Test resetting circuit breaker. (+3 more)

### Community 226 - "Community 226"
Cohesion: 0.17
Nodes (11): Test _load_prompt returns file content., Test that _initialize_session sets the query., Test that _initialize_session sets the query., Test that _initialize_session sets the query., Test that _initialize_session sets the query., Test that _initialize_session sets the query., Test that _initialize_session sets the query., Test that _initialize_session sets the query. (+3 more)

### Community 227 - "Community 227"
Cohesion: 0.17
Nodes (11): Test DEPLOY route constant., Test DEPLOY route constant., Test DEPLOY route constant., Test DEPLOY route constant., Test DEPLOY route constant., Test DEPLOY route constant., Test DEPLOY route constant., Test DEPLOY route constant. (+3 more)

### Community 228 - "Community 228"
Cohesion: 0.17
Nodes (11): Test _should_summarize returns True when goal achieved., Test _needs_deployment returns True when stage is deploy., Test _needs_deployment returns True when stage is deploy., Test _needs_deployment returns True when stage is deploy., Test _needs_deployment returns True when stage is deploy., Test _needs_deployment returns True when stage is deploy., Test _needs_deployment returns True when stage is deploy., Test _needs_deployment returns True when stage is deploy. (+3 more)

### Community 229 - "Community 229"
Cohesion: 0.17
Nodes (11): Test error message format., Test error message format., Test error message format., Test error message format., Test error message format., Test error message format., Test error message format., Test error message format. (+3 more)
...
Cohesion: 0.18
Nodes (10): Test incrementing tries counter., Test incrementing tries counter., Test incrementing tries counter., Test incrementing tries counter., Test incrementing tries counter., Test incrementing tries counter., Test incrementing tries counter., Test incrementing tries counter. (+2 more)

### Community 240 - "Community 240"
Cohesion: 0.18
Nodes (10): Test creating AgentLoop with custom tools module., Test that _initialize_session creates a session ID., Tests for Route constants., Test that _initialize_session creates a session ID., Test that _initialize_session creates a session ID., Test that _initialize_session creates a session ID., Test that _initialize_session creates a session ID., Test that _initialize_session creates a session ID. (+2 more)

### Community 241 - "Community 241"
Cohesion: 0.18
Nodes (10): Tests for Route constants., Test DEPLOY step type constant., Test DEPLOY step type constant., Test DEPLOY step type constant., Test DEPLOY step type constant., Test DEPLOY step type constant., Test DEPLOY step type constant., Test DEPLOY step type constant. (+2 more)

### Community 242 - "Community 242"
Cohesion: 0.22
Nodes (8): get_rate_limit(), get_rate_limit(), Get rate limit from environment variable.      Returns rate limit string for slo, Tests for rate limit configuration., Test default rate limit is 100/minute when env var not set., Test rate limit can be set via environment variable., Test that limiter is attached to app state., TestRateLimitConfiguration
...
Cohesion: 0.2
Nodes (10): add_workflow_step(), Add step to existing GitHub workflow., Add step to existing GitHub workflow., Add step to existing GitHub workflow., Add step to existing GitHub workflow., Add step to existing GitHub workflow., Add step to existing GitHub workflow., Add step to existing GitHub workflow. (+2 more)

### Community 246 - "Community 246"
Cohesion: 0.2
Nodes (10): Validate a tabular dataset (CSV, Parquet, JSON)., Validate a tabular dataset (CSV, Parquet, JSON)., Validate a tabular dataset (CSV, Parquet, JSON)., Validate a tabular dataset (CSV, Parquet, JSON)., Validate a tabular dataset (CSV, Parquet, JSON)., Validate a tabular dataset (CSV, Parquet, JSON)., Validate a tabular dataset (CSV, Parquet, JSON)., Validate a tabular dataset (CSV, Parquet, JSON). (+2 more)

### Community 247 - "Community 247"
Cohesion: 0.2
Nodes (10): compare_distributions(), Compare distributions between a reference dataset and current dataset for drift, Compare distributions between a reference dataset and current dataset for drift, Compare distributions between a reference dataset and current dataset for drift, Compare distributions between a reference dataset and current dataset for drift, Compare distributions between a reference dataset and current dataset for drift, Compare distributions between a reference dataset and current dataset for drift, Compare distributions between a reference dataset and current dataset for drift (+2 more)
...
Cohesion: 0.2
Nodes (10): analyze_training_results(), Analyze training results and suggest improvements., Analyze training results and suggest improvements., Analyze training results and suggest improvements., Analyze training results and suggest improvements., Analyze training results and suggest improvements., Analyze training results and suggest improvements., Analyze training results and suggest improvements. (+2 more)
...
Cohesion: 0.2
Nodes (7): get_async_config(), get_async_db(), Async Database Session Module for MLOps Agent.  Provides async PostgreSQL connec, FastAPI dependency for async database sessions.      Usage in FastAPI endpoints:, Get async database configuration singleton.      Returns:         AsyncDatabaseC, test_config_singleton(), test_get_async_db_generator()
...
Cohesion: 0.2
Nodes (10): check_accuracy_threshold(), Check if accuracy threshold is met., Check if accuracy threshold is met., Check if accuracy threshold is met., Check if accuracy threshold is met., Check if accuracy threshold is met., Check if accuracy threshold is met., Check if accuracy threshold is met. (+2 more)
...
Cohesion: 0.22
Nodes (9): detect_runtime_environment(), Record local runtime context without provisioning cloud resources., Record local runtime context without provisioning cloud resources., Record local runtime context without provisioning cloud resources., Record local runtime context without provisioning cloud resources., Record local runtime context without provisioning cloud resources., Record local runtime context without provisioning cloud resources., Record local runtime context without provisioning cloud resources. (+1 more)
...
Cohesion: 0.22
Nodes (9): log_mlflow_artifact(), Log artifact to MLflow., Log artifact to MLflow., Log artifact to MLflow., Log artifact to MLflow., Log artifact to MLflow., Log artifact to MLflow., Log artifact to MLflow. (+1 more)
...
## Knowledge Gaps
- **5711 isolated node(s):** `Run a shell command and return result.`, `Check if a CLI tool is installed.`, `Ensure directory exists and return Path object.`, `Analyze project for configuration needs.`, `Validate Hydra configuration.` (+5706 more)
...
- **Why does `AgentLoop` connect `Community 8` to `Community 131`, `Community 5`, `Community 134`, `Community 135`, `Community 7`, `Community 11`, `Community 16`, `Community 18`, `Community 19`, `Community 25`, `Community 26`, `Community 282`, `Community 28`, `Community 27`, `Community 284`, `Community 31`, `Community 295`, `Community 45`, `Community 47`, `Community 49`, `Community 309`, `Community 55`, `Community 58`, `Community 62`, `Community 63`, `Community 202`, `Community 203`, `Community 204`, `Community 205`, `Community 91`, `Community 92`, `Community 224`, `Community 97`, `Community 98`, `Community 99`, `Community 110`, `Community 114`, `Community 117`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 1` to `Community 0`, `Community 130`, `Community 4`, `Community 6`, `Community 12`, `Community 16`, `Community 28`, `Community 284`, `Community 31`, `Community 46`, `Community 50`, `Community 320`, `Community 321`, `Community 322`, `Community 323`, `Community 324`, `Community 325`, `Community 198`, `Community 326`, `Community 72`, `Community 328`, `Community 330`, `Community 331`, `Community 332`, `Community 333`, `Community 334`, `Community 335`, `Community 336`, `Community 329`, `Community 82`, `Community 83`, `Community 96`, `Community 327`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `AsyncSessionRepository` connect `Community 3` to `Community 9`, `Community 15`, `Community 16`, `Community 19`, `Community 244`, `Community 284`, `Community 24`, `Community 28`, `Community 31`?**
...
- **Are the 454 inferred relationships involving `AgentLoop` (e.g. with `AgentEventHandler` and `RunRequest`) actually correct?**
  _`AgentLoop` has 454 INFERRED edges - model-reasoned connections that need verification._