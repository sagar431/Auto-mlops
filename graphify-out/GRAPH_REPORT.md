...
## Corpus Check
- 200 files · ~319,176 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11619 nodes · 24721 edges · 1357 communities (279 shown, 1078 thin omitted)
- Extraction: 46% EXTRACTED · 54% INFERRED · 0% AMBIGUOUS · INFERRED: 13334 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5e75ac13`
...
4. `AgentLoop` - 524 edges
5. `AuthenticationError` - 517 edges
6. `SessionRepository` - 437 edges
7. `ModelMetrics` - 413 edges
8. `AsyncSessionRepository` - 398 edges
9. `ValidationSeverity` - 396 edges
10. `DataValidator` - 374 edges
...
## Communities (1357 total, 1078 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (497): AddDataToDVCInput, AddWorkflowStepInput, AnalyzeProjectConfigInput, AnalyzeTrainingResultsInput, BuildMLDockerImageInput, call_tool(), CaptureLitserveLogsAndEndpointInput, CheckAccuracyThresholdInput (+489 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (297): Test DELETE /admin/keys/{id} fails for non-admin users., Tests for POST /admin/users endpoint., Create a client with admin JWT token., Test creating a user with admin privileges., Test creating an admin user., Test creating a user with duplicate username fails., Test creating a user with duplicate email fails., Tests for POST /admin/keys endpoint. (+289 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (332): _approval_record_evidence(), _approved_transfer_record_matches(), _artifact_checksum(), _artifact_reference_from_run(), _baseline_metric_value(), _bounded_training_blocked_result(), _bounded_training_verification_results(), _build_split_manifest() (+324 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (266): Test that API key auth is attempted before JWT when both are provided., Test that JWT is used when API key is invalid., Test APIKeyManager takes priority over APIKeyAuth hashed keys., Test Bearer token with extra spaces., Test Bearer token with only prefix, no token., Test non-Bearer authorization scheme., Tests for API key format handling., Test empty API key header value. (+258 more)
...
Cohesion: 0.02
Nodes (192): Get session by ID, loading from database if not cached., Tests for MemorySearch class with database backend., Test initialization without database session., Test initialization with database session., Test loading sessions from empty database., Test loading sessions with data in database., Test that loaded session entries have correct structure., Tests for MemorySearch search methods. (+184 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (157): Test that expired keys fail verification., Test that verification updates last_used_at., Test verification with required scope present., Test verification fails when required scope is missing., Tests for API key revocation., Test revoking a key by ID., Tests for API key generation., Test revoking a nonexistent key. (+149 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (139): Test updating agent session timestamp., Test session_id uniqueness constraint., Test querying agent session by session_id., Tests for Step model., Test creating a step., Test marking step as completed., Clean up database state before and after each test., Test marking step as failed. (+131 more)
...
Cohesion: 0.02
Nodes (139): Raised when a step execution fails., Raised when a step execution fails., Raised when a step execution fails., Raised when a step execution fails., Tracks step execution attempts and limits with circuit breaker protection., Tracks step execution attempts and limits with circuit breaker protection., Tracks step execution attempts and limits with circuit breaker protection., Tracks step execution attempts and limits with circuit breaker protection. (+131 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (106): Data Quality Module for MLOps Agent  Provides data profiling, validation, and qu, AnomalyDetectionResult, AnomalyRecord, AnomalyType, ColumnStatistics, DataQualityReport, DataSchema, DatasetStatistics (+98 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (104): Tests for Data Quality Module  Tests for DataValidator, DataProfiler, and relate, Test null value checking., Test range validation., Test range validation failure., Test pattern validation., Test allowed values validation., Test allowed values validation failure., Test duplicate row detection. (+96 more)

### Community 12 - "Community 12"
Cohesion: 0.02
Nodes (116): add_workflow_step(), analyze_project_config(), create_github_workflow(), create_hydra_config(), end_mlflow_run(), GenerateTorchserveConfigInput, get_best_mlflow_run(), init_mlflow_experiment() (+108 more)
...
Cohesion: 0.02
Nodes (92): ModelManager, Generate a response from the LLM with fallback chain support.          Args:, Manages LLM providers and model configurations.     Handles API calls with retry, Build the ordered list of models to try, starting from the specified model., Generate using Google Gemini., Generate using OpenAI., Generate using Anthropic Claude., Generate plain text response with fallback chain support. (+84 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (90): Test password verification with empty password., Test that timestamps are set on creation., Tests for the APIKey SQLModel., Test basic API key creation., Test that default values are set correctly., Test API key generation., Test API key hashing., Test that different keys produce different hashes. (+82 more)

### Community 16 - "Community 16"
Cohesion: 0.02
Nodes (88): approve_action(), get_session_details(), get_session_status(), _has_session_access(), require_session_access(), run_agent_session(), SessionManager, websocket_endpoint() (+80 more)

### Community 17 - "Community 17"
Cohesion: 0.03
Nodes (81): AgentSession, load(), load_sync(), Agent Session for MLOps Agent - Session management with experiment snapshots.  T, Mark session as completed., Serialize session to dictionary., Serialize session to JSON-compatible dict (alias for to_dict)., Save session to database asynchronously. (+73 more)

### Community 18 - "Community 18"
Cohesion: 0.03
Nodes (88): AgentLoop, Validate selected registry approval gates before tool execution., Derive setup_pipeline status from captured success contract evidence., Derive selected registry workflow status from captured evidence., Main agent loop for MLOps operations.     Implements the Perception -> Decision, Main agent loop for MLOps operations.     Implements the Perception -> Decision, Main agent loop for MLOps operations.     Implements the Perception -> Decision, Validate setup_pipeline registry approval gates before tool execution. (+80 more)

### Community 19 - "Community 19"
Cohesion: 0.03
Nodes (99): Decorator for adding timeout to async functions.      Usage:         @timeout(30, Raised when an operation exceeds its timeout., Execute an async operation with a timeout.      Usage:         result = await wi, timeout(), TimeoutError, with_timeout(), circuit_config(), Tests for CircuitBreaker class. (+91 more)

### Community 20 - "Community 20"
Cohesion: 0.03
Nodes (74): Perception module for MLOps Agent. ML pipeline awareness and intent understandin, Perception, Perception Module for MLOps Agent. Analyzes ML pipeline context and routes to ap, Get fallback output when LLM fails., Perception module for understanding ML pipeline context.     Extracts entities,, Run perception analysis on input context.          Args:             perception_, Normalize and validate perception output., Tests for structured logging in perception.py. (+66 more)

### Community 21 - "Community 21"
Cohesion: 0.02
Nodes (105): add_data_to_dvc(), build_ml_docker_image(), check_tool_installed(), configure_dvc_remote(), create_dvc_pipeline(), create_ml_dockerfile(), detect_gpu_cuda(), dvc_pull() (+97 more)

### Community 22 - "Community 22"
Cohesion: 0.04
Nodes (81): test_approval_gate_uses_controlled_risk_categories(), _approval_gate_for_step(), _approval_record_matches_gate(), ApprovalGate, ApprovalStatus, _artifact_matches_requirement(), _artifact_requirement_satisfied(), _artifact_requirements_for_check() (+73 more)

### Community 23 - "Community 23"
Cohesion: 0.03
Nodes (68): Dataset, load_imdb_data(), Load IMDB movie review dataset from local directory.      Expects directory stru, create_cifar10_loaders(), create_huggingface_tokenizer(), get_cifar10_transforms(), HuggingFaceTextDataset, load_imdb_huggingface() (+60 more)

### Community 24 - "Community 24"
Cohesion: 0.03
Nodes (54): evaluate_model(), get_test_transforms(), Get transforms for test data., Evaluate model on test set.      Args:         model: Trained model         data, Evaluate model on test set.      Args:         model: Trained model.         voc, CIFAR10CNN, CNN architecture optimized for CIFAR-10 (32x32 images).      Architecture:     -, Tests for DVC pipeline configuration. (+46 more)
...
Cohesion: 0.02
Nodes (91): create_fastapi_app(), create_gradio_interface(), create_helm_chart(), create_inference_service_yaml(), create_k8s_configmap_yaml(), create_k8s_deployment_yaml(), create_k8s_hpa_yaml(), create_k8s_ingress_yaml() (+83 more)

### Community 27 - "Community 27"
Cohesion: 0.05
Nodes (53): collate_fn(), create_data_loaders(), Create train and validation data loaders.      Returns:         Tuple of (train_, Dataset for text classification.      Args:         texts: List of text strings., Vocabulary for text tokenization.      Maintains mappings between words and indi, Generate and save synthetic data for testing.      Args:         data_dir: Direc, Collate function for DataLoader.      Pads sequences to the same length within a, Create train and test data loaders.      Args:         train_texts: List of trai (+45 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (88): Tests for AgentLoop event emission., Tests for AgentLoop event emission., Integration tests for AgentLoop.run method., Integration tests for AgentLoop.run method., Tests for AgentLoop event emission., Integration tests for AgentLoop.run method., Integration tests for AgentLoop.run method., Tests for AgentLoop event emission. (+80 more)
...
Cohesion: 0.03
Nodes (54): Run the MLOps agent with a query.      Args:         query: User query (e.g., "S, Run the MLOps agent with a query.      Args:         query: User query (e.g., "S, Run the MLOps agent with a query.      Args:         query: User query (e.g., "S, Run the MLOps agent with a query.      Args:         query: User query (e.g., "S, run_mlops_agent(), Select an existing model artifact or preflight artifact for LitServe deployment., Select a model artifact for deterministic training comparison or LitServe deploy, select_best_model_artifact() (+46 more)

### Community 32 - "Community 32"
Cohesion: 0.03
Nodes (53): Mark a step as failed and record error., Attach summarizer output to session memory., Simple template rendering with ${var} syntax., Simple template rendering with ${var} syntax., Simple template rendering with ${var} syntax., render_template(), anomaly_csv(), current_csv() (+45 more)
...
Cohesion: 0.04
Nodes (53): calculate_delay(), Retry Pattern with Exponential Backoff.  Provides configurable retry logic with, Determine if an error should trigger a retry.      Args:         error: The exce, Context manager for retry operations.      Usage:         async with RetryContex, Check if more attempts should be made., Record a successful attempt., Record a failed attempt and wait before next retry if applicable.          Args:, Configuration for retry behavior. (+45 more)
...
Cohesion: 0.04
Nodes (49): create_dataloaders(), load_data(), Dataset utilities for tabular regression., PyTorch Dataset for tabular regression data., Initialize dataset.          Args:             features: Feature matrix of shape, Load data from CSV files.      Args:         data_dir: Directory containing trai, Create train and test dataloaders.      Args:         data_dir: Directory contai, TabularDataset (+41 more)

### Community 40 - "Community 40"
Cohesion: 0.03
Nodes (57): Run the self-improvement loop for training., Run the deployment workflow., Run the self-improvement loop for training., Run the self-improvement loop for training., Run the deployment workflow., Run the deployment workflow., Attempt to generate rollback instructions for a failed deployment., Attempt to generate rollback instructions for a failed deployment. (+49 more)
...
Cohesion: 0.04
Nodes (41): test_require_rate_limit_decorator(), JWTPayload, PathTraversalError, RateLimiter, RateLimitExceeded, Security tests for MLOps Agent API authentication and authorization., JWT token payload structure., Exception raised when rate limit is exceeded. (+33 more)

### Community 43 - "Community 43"
Cohesion: 0.05
Nodes (45): check_data_quality(), Check data quality using Great Expectations-based validation.      Validates a d, Check data quality using Great Expectations-based validation.      Validates a d, Check data quality using Great Expectations-based validation.      Validates a d, Check data quality using Great Expectations-based validation.      Validates a d, check_data_quality(), create_expectation_suite(), profile_dataset() (+37 more)
...
Cohesion: 0.04
Nodes (35): Tests for API key revocation., Test revoking a key by ID., Test revoking a nonexistent key., Test revoking a key using the raw key., Test revoking an invalid raw key., Test revoking an empty raw key., Test revoking all keys for a user., Tests for listing API keys. (+27 more)

### Community 48 - "Community 48"
Cohesion: 0.1
Nodes (37): admin_client(), jwt_headers(), api_key_only_env(), auth_disabled_env(), both_auth_enabled_env(), jwt_only_env(), mock_request(), test_api_key_manager_priority_over_hashed_keys() (+29 more)

### Community 49 - "Community 49"
Cohesion: 0.1
Nodes (36): Enum, ConceptDriftDetector, DriftDetector, Drift Detector with Evidently Integration.  Provides data drift and model drift, Detect drift using Evidently., Data and model drift detector using Evidently AI.      Features:     - Detect da, Fallback drift detection using basic statistics.          Uses Kolmogorov-Smirno, Calculate drift severity based on drift share. (+28 more)
...
Cohesion: 0.04
Nodes (43): Test IMPROVE step type constant., Test IMPROVE step type constant., Test resetting circuit breaker., Tests for AgentLoop initialization., Test resetting circuit breaker., Test creating AgentLoop with event callback., Tests for AgentLoop initialization., Test _load_prompt returns file content. (+35 more)

### Community 53 - "Community 53"
Cohesion: 0.05
Nodes (33): Bulkhead, BulkheadConfig, BulkheadFullError, BulkheadRegistry, BulkheadStats, Bulkhead Pattern Implementation.  Provides resource isolation to prevent cascadi, Try to acquire a permit without blocking., Acquire a permit from the bulkhead.          Raises:             BulkheadFullErr (+25 more)

### Community 54 - "Community 54"
Cohesion: 0.05
Nodes (31): Validate ML dataset for quality issues.      Performs various data quality check, Validate ML dataset for quality issues.      Performs various data quality check, Validate a tabular dataset (CSV, Parquet, JSON)., Validate a tabular dataset (CSV, Parquet, JSON)., Validate ML dataset for quality issues.      Performs various data quality check, Validate a tabular dataset (CSV, Parquet, JSON)., validate_dataset(), _validate_tabular_dataset() (+23 more)
...
Cohesion: 0.04
Nodes (47): analyze_training_results(), check_accuracy_threshold(), compare_distributions(), detect_anomalies(), estimate_deployment_cost(), generate_iam_policy(), log_mlflow_artifact(), Generate a least-privilege IAM policy document. (+39 more)

### Community 57 - "Community 57"
Cohesion: 0.07
Nodes (43): List all sessions from database, optionally filtered by status., Delete a session from database and cache., get_async_session(), Async context manager for database sessions.      Yields an async database sessi, clean_db_state(), cleanup(), Clean up database state before and after each test., Create a temporary database file path. (+35 more)

### Community 58 - "Community 58"
Cohesion: 0.06
Nodes (26): build_perception_input(), Build input for perception module.      Args:         query: User query, Tests for build_perception_input function., Test that build_perception_input returns correct structure., Test that build_perception_input includes available tools., Test that build_perception_input uses context state., Test that build_perception_input limits memory items., Test that build_perception_input handles empty memory. (+18 more)
...
Cohesion: 0.05
Nodes (34): Tests for AgentLoop routing logic., Test _should_summarize returns True when goal achieved., Test _should_summarize returns True when route is summarize., Test _needs_improvement returns True when below threshold., Tests for AgentLoop routing logic., Test _needs_deployment returns True when route is deploy., Test _should_summarize returns True when goal achieved., Test _should_summarize returns True when route is summarize. (+26 more)
...
Cohesion: 0.1
Nodes (22): GLUBlock, MLP, Multi-Layer Perceptron for tabular regression.      A feedforward neural network, Get activation function by name., Gated Linear Unit block used in TabNet., TabNet architecture for tabular data.      A simplified implementation of TabNet, TabNet, Test loading model with separate config file. (+14 more)
...
Cohesion: 0.07
Nodes (20): Tests for input validation., Test successful path validation., Test path traversal detection., Test path validation with base path restriction., Test empty path validation., Test string sanitization., Test string length truncation., Test string sanitization with HTML allowed. (+12 more)
...
Cohesion: 0.12
Nodes (32): lifespan(), lifespan(), Lifespan context manager for startup/shutdown., close_async_db(), get_async_engine(), init_async_db(), Get or create async SQLAlchemy engine singleton.      Creates appropriate engine, Initialize database schema asynchronously.      Creates all tables defined in SQ (+24 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (22): require_admin(), Dependency that requires admin privileges.      Checks if the current user has a, require_admin(), client(), Test DELETE /admin/keys/{id} fails for non-admin users., Tests for POST /admin/users endpoint., Test creating a user with admin privileges., Test creating an admin user. (+14 more)

### Community 84 - "Community 84"
Cohesion: 0.1
Nodes (31): test_require_roles_any_match(), test_require_roles_with_none_roles(), test_require_scopes_all_must_match(), test_scope_case_sensitivity(), auth_disabled_env(), _call_role_checker(), _call_scope_checker(), mock_request() (+23 more)

### Community 85 - "Community 85"
Cohesion: 0.06
Nodes (17): Tests for DVC pipeline configuration., Tests for DVC pipeline configuration., Test that dvc.yaml exists., Test that dvc.yaml exists., Test that dvc.yaml is valid YAML., Test prepare_data stage configuration., Test that train stage is defined., Test train stage configuration. (+9 more)
...
Cohesion: 0.07
Nodes (26): Tests for run_mlops_agent convenience function., Tests for AgentLoop _handle_failure method., Tests for run_mlops_agent convenience function., Tests for AgentLoop _handle_failure method., Tests for run_mlops_agent convenience function., Test _needs_improvement returns False when at threshold., Test _needs_improvement returns False when at threshold., Tests for run_mlops_agent convenience function. (+18 more)

### Community 92 - "Community 92"
Cohesion: 0.08
Nodes (24): mock_request(), mock_request_no_client(), mock_request_with_forwarded(), rate_limit_config(), rate_limit_disabled_config(), rate_limiter(), Tests for cleanup of expired request entries., Test that expired requests are cleaned up. (+16 more)
...
Cohesion: 0.08
Nodes (24): Tests for AgentLoop _pick_next_step method., Test _pick_next_step returns first pending step., Test _pick_next_step skips completed steps., Test _pick_next_step returns None when all completed., Test _pick_next_step returns None when no steps., Tests for AgentLoop _pick_next_step method., Test _pick_next_step returns first pending step., Test _pick_next_step skips completed steps. (+16 more)

### Community 95 - "Community 95"
Cohesion: 0.13
Nodes (17): Wrapper class for tabular regression inference., Initialize the regressor.          Args:             model_path: Path to model c, TabularRegressor, Test batch prediction with DataFrame., Test prediction with feature scaling., Create and save a model for testing., Create and save a scaler for testing., Tests for TabularRegressor class. (+9 more)

### Community 96 - "Community 96"
Cohesion: 0.08
Nodes (23): Tests for Route constants., Test SUMMARIZE route constant., Test DECISION route constant., Test IMPROVE route constant., Test DEPLOY route constant., Test SUMMARIZE route constant., Test DECISION route constant., Test IMPROVE route constant. (+15 more)
...
Cohesion: 0.1
Nodes (22): Auth(), mock_request(), Create a mock FastAPI request., Create a security config with valid API keys., Create a security config with JWT enabled., Tests for security middleware., Tests for security decorators., Integration tests combining multiple security components. (+14 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (20): Test recording step failures., Test recording step failures., Test recording step failures., Test should_continue when at limit., Test recording step failures., Test should_continue when at limit., Test should_continue when at limit., Test has_exceeded_retries when within limit. (+12 more)
...
Cohesion: 0.09
Nodes (20): Test error message format., Tests for StepExecutionError exception., Test creating StepExecutionError., Test StepExecutionError is an Exception., Test error message format., Tests for StepExecutionError exception., Test creating StepExecutionError., Test StepExecutionError is an Exception. (+12 more)
...
Cohesion: 0.09
Nodes (13): Test basic distribution comparison., Test detecting distribution drift., Test comparing specific columns., Test handling non-existent reference file., Test handling non-existent current file., Test schema validation functions., Test basic schema validation., Test detecting missing column. (+5 more)
...
Cohesion: 0.12
Nodes (14): Tests for security headers., Test default security headers., Test overriding default headers., TestSecurityHeaders, Security headers configuration.      Provides recommended security headers for H, Get all security headers., Middleware to add security headers to all responses.      Usage:         app.mid, security_headers_middleware() (+6 more)

### Community 120 - "Community 120"
Cohesion: 0.12
Nodes (11): _get_tool_params(), Get parameter names for a function., Get parameter names for a function., Initialize the API key manager with in-memory storage., Tests for _get_tool_params helper., Test getting parameter names from function., Test getting params from function with no arguments., Test getting params from lambda function. (+3 more)
...
Cohesion: 0.16
Nodes (16): get_current_user(), get_current_user_optional(), FastAPI dependency to optionally get the current user.      Similar to `get_curr, FastAPI dependency to get the current authenticated user.      This dependency a, test_anonymous_when_auth_disabled(), test_api_key_auth_via_legacy_system(), test_api_key_auth_via_manager(), test_api_key_with_no_user_id() (+8 more)

### Community 124 - "Community 124"
Cohesion: 0.14
Nodes (9): MLOpsClient, List available MCP tools., Start an agent session without waiting for completion.          Args:, List past sessions.          Args:             limit: Maximum number of sessions, Get system and agent metrics., Close the HTTP client., Synchronous client for the Auto-MLOps API.      Usage:         client = MLOpsCli, Initialize the client.          Args:             api_key: API key for authentic (+1 more)
...
Cohesion: 0.11
Nodes (10): Tests that verify endpoints have the rate limit decorator., Verify /health endpoint has request parameter for rate limiting., Verify /status/{session_id} endpoint has request parameter., Verify /sessions endpoint has request parameter., Verify /tools endpoint has request parameter., Verify /metrics endpoint has request parameter., Verify GET /logs endpoint has request parameter., Verify POST /logs endpoint has request parameter. (+2 more)
...
Cohesion: 0.11
Nodes (18): create_ecr_repo(), _ensure_boto3(), get_ecr_login(), list_eks_clusters(), Get ECR login command., List EKS clusters in a region., Create or get an ECR repository., Get ECR login command. (+10 more)

### Community 140 - "Community 140"
Cohesion: 0.12
Nodes (15): Tests for StepType constants., Test CODE step type constant., Tests for Route constants., Tests for StepType constants., Test CODE step type constant., Test DEPLOY step type constant., Tests for StepType constants., Test CODE step type constant. (+7 more)
...
Cohesion: 0.12
Nodes (9): Test baseline experiment config loads., Test high_accuracy experiment config loads., Tests for sklearn config content validity., Test that main config loads without error., Test Ridge config loads and has required fields., Test RandomForest config loads and has required fields., Test GradientBoosting config loads and has required fields., Test training config loads and has required fields. (+1 more)
...
Cohesion: 0.13
Nodes (13): get_async_config(), get_async_db(), get_async_session_factory(), Async Database Session Module for MLOps Agent.  Provides async PostgreSQL connec, Get or create async session factory singleton.      Returns:         Async SQLAl, FastAPI dependency for async database sessions.      Usage in FastAPI endpoints:, Reset database by dropping and recreating all tables asynchronously.      WARNIN, Get async database configuration singleton.      Returns:         AsyncDatabaseC (+5 more)
...
Cohesion: 0.14
Nodes (8): Tests for Decision fallback behavior., Test fallback output has correct structure., Test fallback for setup stage., Test fallback for config stage., Test fallback for training stage., Test fallback uses project_path from entities., Test fallback defaults project_path to '.'., TestDecisionFallback
...
Cohesion: 0.17
Nodes (7): Integration tests for authentication flow., Test complete API key authentication flow., Test complete JWT authentication flow., Test API key manager complete lifecycle., Test session ownership complete flow., Test input validation prevents security issues., TestAuthenticationIntegration
...
Cohesion: 0.17
Nodes (7): Tests for rate limiting., Test that requests within limit are allowed., Test that rate limit is enforced., Test getting remaining requests., Test that rate limiting can be disabled., Test client ID extraction from X-Forwarded-For header., TestRateLimiter
...
Cohesion: 0.18
Nodes (7): Synchronous MLOps Client for the Auto-MLOps API., Result of an agent session., Get the status of a session.          Args:             session_id: The session, Run a query and wait for completion.          Args:             query: Natural l, Information about an MCP tool., SessionResult, ToolInfo

### Community 188 - "Community 188"
Cohesion: 0.18
Nodes (9): Test getting circuit stats., Test getting circuit stats., Test _needs_improvement returns False when no accuracy recorded., Test _needs_improvement returns False when no accuracy recorded., Test getting circuit stats., Test getting circuit stats., Test _needs_improvement returns False when no accuracy recorded., Test getting circuit stats. (+1 more)
...
Cohesion: 0.2
Nodes (6): Tests for error message content., Test AuthenticationError default message., Test AuthenticationError with custom message., Test AuthorizationError default message., Test AuthorizationError with custom message., TestErrorMessages

### Community 193 - "Community 193"
Cohesion: 0.2
Nodes (6): Integration tests for database operations., Test creating and querying a user., Test creating a user with an API key., Test that foreign key constraints are enforced., Test unique constraints on username and email., TestDatabaseIntegration
...
Cohesion: 0.25
Nodes (8): create_mar_archive(), Validate an image dataset directory., Validate an image dataset directory., Create TorchServe MAR (Model Archive) file., Create TorchServe MAR (Model Archive) file., Validate an image dataset directory., Create TorchServe MAR (Model Archive) file., _validate_image_dataset()
...
Cohesion: 0.4
Nodes (5): create_lambda_dockerfile(), Create Dockerfile for AWS Lambda deployment., Create Dockerfile for AWS Lambda deployment., Create Dockerfile for AWS Lambda deployment., Create Dockerfile for AWS Lambda deployment.

### Community 250 - "Community 250"
Cohesion: 0.4
Nodes (5): generate_cdk_stack(), Generate AWS CDK stack for Lambda deployment., Generate AWS CDK stack for Lambda deployment., Generate AWS CDK stack for Lambda deployment., Generate AWS CDK stack for Lambda deployment.
...
Cohesion: 0.4
Nodes (5): deploy_to_huggingface(), Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces., Deploy Gradio app to Hugging Face Spaces.
...
## Knowledge Gaps
- **4070 isolated node(s):** `Run a shell command and return result.`, `Check if a CLI tool is installed.`, `Ensure directory exists and return Path object.`, `Analyze project for configuration needs.`, `Validate Hydra configuration.` (+4065 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **1078 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `AgentLoop` connect `Community 18` to `Community 5`, `Community 261`, `Community 8`, `Community 9`, `Community 140`, `Community 13`, `Community 14`, `Community 16`, `Community 17`, `Community 20`, `Community 22`, `Community 28`, `Community 31`, `Community 33`, `Community 164`, `Community 165`, `Community 166`, `Community 167`, `Community 40`, `Community 50`, `Community 52`, `Community 185`, `Community 58`, `Community 188`, `Community 68`, `Community 69`, `Community 80`, `Community 81`, `Community 91`, `Community 94`, `Community 96`, `Community 224`, `Community 100`, `Community 103`, `Community 106`, `Community 113`, `Community 121`, `Community 255`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `CurrentUser` connect `Community 1` to `Community 0`, `Community 3`, `Community 6`, `Community 8`, `Community 16`, `Community 272`, `Community 273`, `Community 275`, `Community 276`, `Community 277`, `Community 274`, `Community 279`, `Community 280`, `Community 281`, `Community 282`, `Community 283`, `Community 284`, `Community 285`, `Community 153`, `Community 287`, `Community 288`, `Community 286`, `Community 42`, `Community 170`, `Community 48`, `Community 51`, `Community 192`, `Community 74`, `Community 83`, `Community 84`, `Community 278`, `Community 86`, `Community 224`, `Community 97`, `Community 115`, `Community 119`, `Community 122`, `Community 123`?**
  _High betweenness centrality (0.096) - this node is a cross-community bridge._
- **Why does `AsyncSessionRepository` connect `Community 4` to `Community 224`, `Community 7`, `Community 8`, `Community 77`, `Community 15`, `Community 16`, `Community 17`, `Community 57`, `Community 29`, `Community 191`?**
